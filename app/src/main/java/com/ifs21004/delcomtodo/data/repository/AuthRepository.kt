...
class AuthRepository private constructor(
    ...
    fun register(name: String, email: String, password: String) = flow {emit(MyResult.Loading)
        try {
            //get success message
